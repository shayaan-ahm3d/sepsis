...
df_contingency = pd.DataFrame(contingency_table, index=['Set A', 'Set B'], columns=['Sepsis Label 0', 'Sepsis Label 1'])

# Create the heatmap
plt.figure(figsize=(8, 6))
sns.heatmap(df_contingency, annot=True, fmt='d', cmap='YlGnBu')  # annot=True shows the values, fmt='d' formats them as integers
